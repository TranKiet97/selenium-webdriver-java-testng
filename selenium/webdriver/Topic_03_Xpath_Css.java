...
public class Topic_03_Xpath_Css {
	...
	public void TC_03_Register_With_Incorrect_Confirm_Email() {
		...
		driver.findElement(By.id("txtFirstname")).sendKeys("John Kenedy");
		driver.findElement(By.id("txtEmail")).sendKeys("johnkenedy@gmail.net");
		driver.findElement(By.id("txtCEmail")).sendKeys("johnkenedy@gmail.com");
		driver.findElement(By.id("txtPassword")).sendKeys("123456");
		driver.findElement(By.id("txtCPassword")).sendKeys("123456");
		driver.findElement(By.id("txtPhone")).sendKeys("0987654321");
		driver.findElement(By.xpath("//form[@id='frmLogin']//button[text()='ĐĂNG KÝ']")).click();
	...
	public void TC_04_Register_With_Password_Less_Than_Six_Chars() {
		...
		driver.findElement(By.id("txtFirstname")).sendKeys("John Kenedy");
		driver.findElement(By.id("txtEmail")).sendKeys("johnkenedy@gmail.net");
		driver.findElement(By.id("txtCEmail")).sendKeys("johnkenedy@gmail.net");
	...
	@Test
	public void TC_01_Register_With_Invalid_Phone_Number() {
		driver.get("https://alada.vn/tai-khoan/dang-ky.html");
		...
		driver.findElement(By.id("txtPhone")).sendKeys("98754321");
		driver.findElement(By.xpath("//form[@id='frmLogin']//button[text()='ĐĂNG KÝ']")).click();
